...
bundle do |bundle|
  ...
  bundle.menu t("search.ruby.css.docs_for_property") do |menu|
  	menu.command t(:docs_for_property)
  end
  bundle.menu t("search.ruby.css.validate") do |menu|
  	menu.command t(:validate)
  end
